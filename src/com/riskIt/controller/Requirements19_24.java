...
// ############################## INITIALIZATION ###################################
   ...
   private void initializeSsnToEducationMap(HashMap<Integer, String> ssnToEducationMap){
        ...
        try {
        	...
        	do{
                	ssnToEducationMap.put(rs.getInt(1), rs.getString(2));
        	}while(rs.next());
   ...
   private void initializeSsnToZipMap(HashMap<Integer, String> ssnToZipMap){
       ...
       try{
         ...
         do{
                ssnToZipMap.put(rs.getInt(1), rs.getString(2));
         }while(rs.next());
         rs.close();
         s.close();
       } catch (SQLException e)
   ...
   private void initializeSsnToWeekWageMap(HashMap<Integer, Integer> ssnToWeekWageMap){
       ...
       try{
         ...
         do{
                ssnToWeekWageMap.put(rs.getInt(1), rs.getInt(2));
         }while(rs.next());
         rs.close(); 
         s.close();
       } catch (SQLException e)
   ...
   private void initializeZipToStateMap(HashMap<String, String> zipToStateMap){
       ...
       try{
         ...
         do{
                zipToStateMap.put(rs.getString(1), rs.getString(2));
         }while(rs.next());
         rs.close();
         s.close();
       } catch (SQLException e)
